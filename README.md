...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/git/https%3A%2F%2Fgitlab.eumetsat.int%2Feumetlab%2Foceans%2Focean-training%2Fapplications%2Focean-case-studies/HEAD?labpath=Index.ipynb)
...
The **ocean-case-studies** repository contains a series of Python-based Jupyter Notebooks 
on ocean phenomena that are generated by the Copernicus Marine Training Services to either 
accompany [EUMETSAT website case studies](https://www.eumetsat.int/case-studies) or as
standalone material.
...
*Note: The copernicusmarine module is distributed under the EUPL license. However, it is only used as a tool 
